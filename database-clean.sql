...
CREATE INDEX IF NOT EXISTS idx_listings_city ON public.listings(location);
...
CREATE INDEX IF NOT EXISTS idx_availability_listing_id ON public.availability_blocks(listing_id);
CREATE INDEX IF NOT EXISTS idx_availability_dates ON public.availability_blocks(date_from, date_to);
